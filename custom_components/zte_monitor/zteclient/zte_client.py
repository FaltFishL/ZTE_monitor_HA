"""
ZTE Router Client — 与 zte_tracker SR7410 源码一致
=====================================================
三步登录 + 全部 10 个 API + 完整设备数据（含实时速率和累计流量）
"""
import hashlib
...
class ZTERouterClient:
    ...
    def get_ntp_info(self) -> dict[str, Any]:
        ...
        return {"current_time": ntp.get("CurrentLocalTime", ""), "zone": ntp.get("ZoneIndex", "")}
